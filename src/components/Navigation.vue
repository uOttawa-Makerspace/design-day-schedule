  ...
  <div>
    <v-navigation-drawer v-model="drawer" app temporary>
      <v-list>
        <v-list-item>
          <v-list-item-content>
            <v-list-item-title class="title">Journée du design hiver 2022</v-list-item-title>
            <v-list-item-title class="title">Winter 2022 Design Day</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
      </v-list>
    ...
    <v-app-bar app id="header">
      <v-toolbar-title>
        <span class="mr-2">Journée du design hiver 2022 / Winter 2022 Design Day</span>
      </v-toolbar-title>
      <v-spacer />
